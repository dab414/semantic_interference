...
The trimming procedures reported in the manuscript were the following:  
...
current_data <- current_data %>% 
  mutate(rt = ifelse(!is.null(rt_block1), rt_block1, rt_block2)) %>% 
